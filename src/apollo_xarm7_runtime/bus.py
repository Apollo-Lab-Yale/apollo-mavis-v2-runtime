...
Primitives are DEFINED in ``apollo_xarm7_core.bus``; this module re-exports
...
from apollo_xarm7_core import Command, CommandBus, CommandResult, HeldState, LatestSlot
